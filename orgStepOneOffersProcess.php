...
$result2 = mysqli_query($connect,
    ...
    VALUES (NULL, '$organization', '$job_title', '$job_description', '$location', '$start_date', '$end_date', '$job_function', '$required_languages', '$required_computer_skills', '$required_travel', '$number_of_openings', '$additional_notes');");
